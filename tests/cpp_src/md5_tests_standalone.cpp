/**
 * @file md5_tests_standalone.cpp
 * @brief D3 Coverage Tests - md5 module (Standalone).
 *
 * @details
 * Tests for MD5 hashing implementation.
 * Uses known MD5 test vectors for validation.
 *
 * This harness validates the behavior of `Descent3/md5_tests_standalone.cpp`. It compiles the real
 * implementation (or a minimal replica when isolation is required) against
 * stubbed engine subsystems and checks the observable contract documented
 * in the source headers and in-game behavior.
 *
 * @par Source
 * `Descent3/md5_tests_standalone.cpp`
 * @par Harness
 * `md5_tests_standalone.cpp`
 * @par Framework
 ...
 * @see Descent3/md5_tests_standalone.cpp
 */
...
/**
 * @brief GTest fixture for MD5Test.
 * @details
 ...
 *
 * @details
 * Exercises the MD5Test code path and asserts observable
...
/**
 * @test MD5Test.Single_a
 * @brief Verifies single a.
 *
 * @details
 * Exercises the MD5Test code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test MD5Test.LargeChunked
 * @brief Verifies large Chunked.
 *
 * @details
 * Exercises the MD5Test code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @brief GTest fixture for MD5PropertyTest.
 * @details
 * Sets up stubbed engine state and helper factories shared
 * across the suite. Each @test starts from the deterministic
 * baseline established in SetUp().
...
/**
 * @test MD5PropertyTest.Deterministic
 * @brief Verifies deterministic.
 *
 * @details
 * Exercises the MD5PropertyTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
 * inputs; no external I/O is performed.
 *
 * @see Descent3/md5_tests_standalone.cpp
...
/**
 * @test MD5PropertyTest.DifferentInputs
 * @brief Verifies different Inputs.
 *
 * @details
 * Exercises the MD5PropertyTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
 ...
 * @brief Verifies single Bytes.
 *
 * @details
 * Exercises the MD5EdgeCase code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
 * inputs; no external I/O is performed.
 *
 * @see Descent3/md5_tests_standalone.cpp
