 ...
 */
/**
 * @file cfile_integration_tests.cpp
 * @brief Unit tests for Descent3/cfile_integration.cpp.
 *
 * @details
 * Covers the public contract of `Descent3/cfile_integration.cpp` — construction, state transitions, error handling and edge cases exercised through the GoogleTest harness.
 *
 * This harness validates the behavior of `Descent3/cfile_integration.cpp`. It compiles the real
 * implementation (or a minimal replica when isolation is required) against
 * stubbed engine subsystems and checks the observable contract documented
 * in the source headers and in-game behavior.
 *
 * @par Source
 * `Descent3/cfile_integration.cpp`
 * @par Harness
 * `cfile_integration_tests.cpp`
 * @par Framework
 ...
 * @see Descent3/cfile_integration.cpp
 */
...
/**
 * @brief GTest fixture for CFileIntegrationTest.
 * @details
...
/**
 * @test CFileIntegrationTest.CFileIO_ReadString
 * @brief Verifies cFile IO Read String.
 *
 * @details
 * Exercises the CFileIntegrationTest code path and asserts observable
...
/**
 * @test CFileIntegrationTest.CFileIO_ReadByte
 * @brief Verifies cFile IO Read Byte.
 *
 * @details
 * Exercises the CFileIntegrationTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test CFileIntegrationTest.CFileIO_ReadShort
 * @brief Verifies cFile IO Read Short.
 *
 * @details
 * Exercises the CFileIntegrationTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test CFileIntegrationTest.CFileIO_ReadInt
 * @brief Verifies cFile IO Read Int.
 *
 * @details
 * Exercises the CFileIntegrationTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test CFileIntegrationTest.CFileIO_Rewind
 * @brief Verifies cFile IO Rewind.
 *
 * @details
 * Exercises the CFileIntegrationTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test CFileIntegrationTest.CFileLibrary_OpenAndRead
 * @brief Verifies cFile Library Open And Read.
 *
 * @details
 * Exercises the CFileIntegrationTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test CFileIntegrationTest.CFileLibrary_OpenFileInLibrary
 * @brief Verifies cFile Library Open File In Library.
 *
 * @details
 * Exercises the CFileIntegrationTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test CFileIntegrationTest.CFileLibrary_WithSearchPath
 * @brief Verifies cFile Library With Search Path.
 *
 * @details
 * Exercises the CFileIntegrationTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test CFileIntegrationTest.CFileLibrary_FileNotFound
 * @brief Verifies cFile Library File Not Found.
 *
 * @details
 * Exercises the CFileIntegrationTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test CFileIntegrationTest.CFileLibrary_CRC
 * @brief Verifies cFile Library CRC.
 *
 * @details
 * Exercises the CFileIntegrationTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test CFileIntegrationTest.CFileLocatePath_Lowercase
 * @brief Verifies cFile Locate Path Lowercase.
 *
 * @details
 * Exercises the CFileIntegrationTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test CFileIntegrationTest.CFileLocatePath_Uppercase
 * @brief Verifies cFile Locate Path Uppercase.
 *
 * @details
 * Exercises the CFileIntegrationTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test CFileIntegrationTest.CFileLocatePath_CamelCase
 * @brief Verifies cFile Locate Path Camel Case.
 *
 * @details
 * Exercises the CFileIntegrationTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test CFileIntegrationTest.CFileLocatePath_NotFound
 * @brief Verifies cFile Locate Path Not Found.
 *
 * @details
 * Exercises the CFileIntegrationTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test CFileIntegrationTest.CFileLocatePath_WithPath
 * @brief Verifies cFile Locate Path With Path.
 *
 * @details
 * Exercises the CFileIntegrationTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test CFileIntegrationTest.CFileLocatePath_CaseInsensitiveMixed
 * @brief Verifies cFile Locate Path Case Insensitive Mixed.
 *
 * @details
 * Exercises the CFileIntegrationTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test CFileIntegrationTest.BaseDirectory_AddAndClear
 * @brief Verifies base Directory Add And Clear.
 *
 * @details
 * Exercises the CFileIntegrationTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test CFileIntegrationTest.BaseDirectory_LocateWithBaseDir
 * @brief Verifies base Directory Locate With Base Dir.
 *
 * @details
 * Exercises the CFileIntegrationTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test CFileIntegrationTest.SearchPath_AddAndClear
 * @brief Verifies search Path Add And Clear.
 *
 * @details
 * Exercises the CFileIntegrationTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test CFileIntegrationTest.SearchPath_FindWithExtensionFilter
 * @brief Verifies search Path Find With Extension Filter.
 *
 * @details
 * Exercises the CFileIntegrationTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test CFileIntegrationTest.FileExist_OnDisk
 * @brief Verifies file Exist On Disk.
 *
 * @details
 * Exercises the CFileIntegrationTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test CFileIntegrationTest.FileExist_InLibrary
 * @brief Verifies file Exist In Library.
 *
 * @details
 * Exercises the CFileIntegrationTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test CFileIntegrationTest.FileExist_NotFound
 * @brief Verifies file Exist Not Found.
 *
 * @details
 * Exercises the CFileIntegrationTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test CFileIntegrationTest.MultipleFiles_Open
 * @brief Verifies multiple Files Open.
 *
 * @details
 * Exercises the CFileIntegrationTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test CFileIntegrationTest.ReadWrite_Roundtrip
 * @brief Verifies read Write Roundtrip.
 *
 * @details
 * Exercises the CFileIntegrationTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test CFileIntegrationTest.Seek_Operations
 * @brief Verifies seek Operations.
 *
 * @details
 * Exercises the CFileIntegrationTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test CFileIntegrationTest.Edge_EmptyFile
 * @brief Verifies edge Empty File.
 *
 * @details
 * Exercises the CFileIntegrationTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test CFileIntegrationTest.Edge_ReadBeyondEOF
 * @brief Verifies edge Read Beyond EOF.
 *
 * @details
 * Exercises the CFileIntegrationTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test CFileIntegrationTest.Edge_CopyFile
 * @brief Verifies edge Copy File.
 *
 * @details
 * Exercises the CFileIntegrationTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
