/**
 * @file fix_tests_standalone.cpp
 * @brief D3 Coverage Tests - Fix (Fixed-Point Math) module (Standalone).
 *
 * @details
 * Tests for fixed-point math operations.
 * Uses seeded RNG for reproducible test data.
 *
 * This harness validates the behavior of `Descent3/fix_tests_standalone.cpp`. It compiles the real
 * implementation (or a minimal replica when isolation is required) against
 * stubbed engine subsystems and checks the observable contract documented
 * in the source headers and in-game behavior.
 *
 * @par Source
 * `Descent3/fix_tests_standalone.cpp`
 * @par Harness
 * `fix_tests_standalone.cpp`
 * @par Framework
 ...
 * @see Descent3/fix_tests_standalone.cpp
 */
...
/**
 * @brief GTest fixture for FixConversionTest.
 * @details
...
/**
 * @test FixConversionTest.FloatToFixOne
 * @brief Verifies float To Fix One.
 *
 * @details
 * Exercises the FixConversionTest code path and asserts observable
...
/**
 * @test FixConversionTest.FloatToFixHalf
 * @brief Verifies float To Fix Half.
 *
 * @details
 * Exercises the FixConversionTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test FixConversionTest.FloatToFixNegative
 * @brief Verifies float To Fix Negative.
 *
 * @details
 * Exercises the FixConversionTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test FixConversionTest.FloatToFixLarge
 * @brief Verifies float To Fix Large.
 *
 * @details
 * Exercises the FixConversionTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test FixConversionTest.IntToFix
 * @brief Verifies int To Fix.
 *
 * @details
 * Exercises the FixConversionTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test FixConversionTest.IntToFixNegative
 * @brief Verifies int To Fix Negative.
 *
 * @details
 * Exercises the FixConversionTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test FixConversionTest.FixToIntTruncates
 * @brief Verifies fix To Int Truncates.
 *
 * @details
 * Exercises the FixConversionTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test FixConversionTest.FixToIntNegativeTruncates
 * @brief Verifies fix To Int Negative Truncates.
 *
 * @details
 * Exercises the FixConversionTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test FixConversionTest.RoundTripFloat
 * @brief Verifies round Trip Float.
 *
 * @details
 * Exercises the FixConversionTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @brief GTest fixture for FixTrigTest.
 * @details
 * Sets up stubbed engine state and helper factories shared
 * across the suite. Each @test starts from the deterministic
 * baseline established in SetUp().
...
/**
 * @test FixTrigTest.SinZero
 * @brief Verifies sin Zero.
 *
 * @details
 * Exercises the FixTrigTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
 * inputs; no external I/O is performed.
 *
 * @see Descent3/fix_tests_standalone.cpp
...
/**
 * @test FixTrigTest.CosZero
 * @brief Verifies cos Zero.
 *
 * @details
 * Exercises the FixTrigTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test FixTrigTest.Sin90Degrees
 * @brief Verifies sin90Degrees.
 *
 * @details
 * Exercises the FixTrigTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test FixTrigTest.Cos90Degrees
 * @brief Verifies cos90Degrees.
 *
 * @details
 * Exercises the FixTrigTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test FixTrigTest.Sin180Degrees
 * @brief Verifies sin180Degrees.
 *
 * @details
 * Exercises the FixTrigTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test FixTrigTest.Cos180Degrees
 * @brief Verifies cos180Degrees.
 *
 * @details
 * Exercises the FixTrigTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test FixTrigTest.Sin270Degrees
 * @brief Verifies sin270Degrees.
 *
 * @details
 * Exercises the FixTrigTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test FixTrigTest.Cos270Degrees
 * @brief Verifies cos270Degrees.
 *
 * @details
 * Exercises the FixTrigTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test FixTrigTest.SinCosSymmetry
 * @brief Verifies sin Cos Symmetry.
 *
 * @details
 * Exercises the FixTrigTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @brief GTest fixture for FixInverseTrigTest.
 * @details
 * Sets up stubbed engine state and helper factories shared
 * across the suite. Each @test starts from the deterministic
 * baseline established in SetUp().
...
/**
 * @test FixInverseTrigTest.AsinZero
 * @brief Verifies asin Zero.
 *
 * @details
 * Exercises the FixInverseTrigTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
 * inputs; no external I/O is performed.
 *
 * @see Descent3/fix_tests_standalone.cpp
...
/**
 * @test FixInverseTrigTest.AsinOne
 * @brief Verifies asin One.
 *
 * @details
 * Exercises the FixInverseTrigTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test FixInverseTrigTest.AcosOne
 * @brief Verifies acos One.
 *
 * @details
 * Exercises the FixInverseTrigTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test FixInverseTrigTest.Atan2Basic
 * @brief Verifies atan2Basic.
 *
 * @details
 * Exercises the FixInverseTrigTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test FixInverseTrigTest.Atan2ZeroY
 * @brief Verifies atan2Zero Y.
 *
 * @details
 * Exercises the FixInverseTrigTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test FixInverseTrigTest.Atan2ZeroX
 * @brief Verifies atan2Zero X.
 *
 * @details
 * Exercises the FixInverseTrigTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @brief GTest fixture for FixFloorCeilTest.
 * @details
 * Sets up stubbed engine state and helper factories shared
 * across the suite. Each @test starts from the deterministic
 * baseline established in SetUp().
...
/**
 * @test FixFloorCeilTest.FloorPositive
 * @brief Verifies floor Positive.
 *
 * @details
 * Exercises the FixFloorCeilTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
 * inputs; no external I/O is performed.
 *
 * @see Descent3/fix_tests_standalone.cpp
...
/**
 * @test FixFloorCeilTest.FloorNegative
 * @brief Verifies floor Negative.
 *
 * @details
 * Exercises the FixFloorCeilTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test FixFloorCeilTest.FloorExact
 * @brief Verifies floor Exact.
 *
 * @details
 * Exercises the FixFloorCeilTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test FixFloorCeilTest.CeilPositive
 * @brief Verifies ceil Positive.
 *
 * @details
 * Exercises the FixFloorCeilTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test FixFloorCeilTest.CeilNegative
 * @brief Verifies ceil Negative.
 *
 * @details
 * Exercises the FixFloorCeilTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test FixFloorCeilTest.CeilExact
 * @brief Verifies ceil Exact.
 *
 * @details
 * Exercises the FixFloorCeilTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test FixFloorCeilTest.FloorCeilInverse
 * @brief Verifies floor Ceil Inverse.
 *
 * @details
 * Exercises the FixFloorCeilTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @brief GTest fixture for FixPropertyTest.
 * @details
 * Sets up stubbed engine state and helper factories shared
 * across the suite. Each @test starts from the deterministic
 * baseline established in SetUp().
...
/**
 * @test FixPropertyTest.SinCosPythagorean
 * @brief Verifies sin Cos Pythagorean.
 *
 * @details
 * Exercises the FixPropertyTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
 * inputs; no external I/O is performed.
 *
 * @see Descent3/fix_tests_standalone.cpp
...
// sin(-x) = -sin(x)
/**
 * @test FixPropertyTest.SinOdd
 * @brief Verifies sin Odd.
 *
 * @details
 * Exercises the FixPropertyTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
// cos(-x) = cos(x) 
/**
 * @test FixPropertyTest.CosEven
 * @brief Verifies cos Even.
 *
 * @details
 * Exercises the FixPropertyTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
// sin(x + 2π) = sin(x)
/**
 * @test FixPropertyTest.SinPeriodic
 * @brief Verifies sin Periodic.
 *
 * @details
 * Exercises the FixPropertyTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
// Atan2 properties
/**
 * @test FixPropertyTest.Atan2Symmetry
 * @brief Verifies atan2Symmetry.
 *
 * @details
 * Exercises the FixPropertyTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test FixPropertyTest.FloatToFixConsistent
 * @brief Verifies float To Fix Consistent.
 *
 * @details
 * Exercises the FixPropertyTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test FixPropertyTest.IntToFixRoundTrip
 * @brief Verifies int To Fix Round Trip.
 *
 * @details
 * Exercises the FixPropertyTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @brief GTest fixture for FixStressTest.
 * @details
 * Sets up stubbed engine state and helper factories shared
 * across the suite. Each @test starts from the deterministic
 * baseline established in SetUp().
...
/**
 * @test FixStressTest.ManyConversions
 * @brief Verifies many Conversions.
 *
 * @details
 * Exercises the FixStressTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
 * inputs; no external I/O is performed.
 *
 * @see Descent3/fix_tests_standalone.cpp
...
/**
 * @test FixStressTest.ManyTrigCalculations
 * @brief Verifies many Trig Calculations.
 *
 * @details
 * Exercises the FixStressTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test FixStressTest.ManyFloorCeil
 * @brief Verifies many Floor Ceil.
 *
 * @details
 * Exercises the FixStressTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
