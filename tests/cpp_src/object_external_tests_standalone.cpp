/**
 * @file object_external_tests_standalone.cpp
 * @brief D3 Coverage Tests - Descent3/object_external module (Standalone).
 *
 * @details
 * Tests for object type constants, flags, and masks.
 * These define the game object system.
 *
 * This harness validates the behavior of `Descent3/object_external_tests_standalone.cpp`. It compiles the real
 * implementation (or a minimal replica when isolation is required) against
 * stubbed engine subsystems and checks the observable contract documented
 * in the source headers and in-game behavior.
 *
 * @par Source
 * `Descent3/object_external_tests_standalone.cpp`
 * @par Harness
 ...
 * @see Descent3/object_external_tests_standalone.cpp
 */
...
/**
 * @brief GTest fixture for ObjectExternalTest.
 * @details
...
/**
 * @test ObjectExternalTest.ObjectHandleBad_IsZero
 * @brief Verifies object Handle Bad Is Zero.
 *
 * @details
 * Exercises the ObjectExternalTest code path and asserts observable
...
/**
 * @test ObjectExternalTest.ObjectHandleNone_IsNegative
 * @brief Verifies object Handle None Is Negative.
 *
 * @details
 * Exercises the ObjectExternalTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test ObjectExternalTest.ObjectHandles_Distinct
 * @brief Verifies object Handles Distinct.
 *
 * @details
 * Exercises the ObjectExternalTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test ObjectExternalTest.ObjectTypes_Defined
 * @brief Verifies object Types Defined.
 *
 * @details
 * Exercises the ObjectExternalTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test ObjectExternalTest.ObjectTypes_Contiguous
 * @brief Verifies object Types Contiguous.
 *
 * @details
 * Exercises the ObjectExternalTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test ObjectExternalTest.ObjectTypes_MaxCount
 * @brief Verifies object Types Max Count.
 *
 * @details
 * Exercises the ObjectExternalTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test ObjectExternalTest.ObjectTypes_Unique
 * @brief Verifies object Types Unique.
 *
 * @details
 * Exercises the ObjectExternalTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test ObjectExternalTest.ObjectTypes_None_IsSpecial
 * @brief Verifies object Types None Is Special.
 *
 * @details
 * Exercises the ObjectExternalTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test ObjectExternalTest.EffectFlags_Defined
 * @brief Verifies effect Flags Defined.
 *
 * @details
 * Exercises the ObjectExternalTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test ObjectExternalTest.EffectFlags_PowersOfTwo
 * @brief Verifies effect Flags Powers Of Two.
 *
 * @details
 * Exercises the ObjectExternalTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test ObjectExternalTest.EffectFlags_ConsecutiveBits
 * @brief Verifies effect Flags Consecutive Bits.
 *
 * @details
 * Exercises the ObjectExternalTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test ObjectExternalTest.ControlTypes_Defined
 * @brief Verifies control Types Defined.
 *
 * @details
 * Exercises the ObjectExternalTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test ObjectExternalTest.ControlTypes_Unique
 * @brief Verifies control Types Unique.
 *
 * @details
 * Exercises the ObjectExternalTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test ObjectExternalTest.MovementTypes_Defined
 * @brief Verifies movement Types Defined.
 *
 * @details
 * Exercises the ObjectExternalTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test ObjectExternalTest.MovementTypes_Contiguous
 * @brief Verifies movement Types Contiguous.
 *
 * @details
 * Exercises the ObjectExternalTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test ObjectExternalTest.MovementClasses_Defined
 * @brief Verifies movement Classes Defined.
 *
 * @details
 * Exercises the ObjectExternalTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test ObjectExternalTest.MovementClasses_Contiguous
 * @brief Verifies movement Classes Contiguous.
 *
 * @details
 * Exercises the ObjectExternalTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test ObjectExternalTest.AttachTypes_Defined
 * @brief Verifies attach Types Defined.
 *
 * @details
 * Exercises the ObjectExternalTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test ObjectExternalTest.AttachTypes_Contiguous
 * @brief Verifies attach Types Contiguous.
 *
 * @details
 * Exercises the ObjectExternalTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test ObjectExternalTest.RenderTypes_Defined
 * @brief Verifies render Types Defined.
 *
 * @details
 * Exercises the ObjectExternalTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test ObjectExternalTest.RenderTypes_Contiguous
 * @brief Verifies render Types Contiguous.
 *
 * @details
 * Exercises the ObjectExternalTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test ObjectExternalTest.ObjectFlags_Defined
 * @brief Verifies object Flags Defined.
 *
 * @details
 * Exercises the ObjectExternalTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test ObjectExternalTest.ObjectFlags_MoreFlags
 * @brief Verifies object Flags More Flags.
 *
 * @details
 * Exercises the ObjectExternalTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test ObjectExternalTest.ObjectFlags_PowersOfTwo
 * @brief Verifies object Flags Powers Of Two.
 *
 * @details
 * Exercises the ObjectExternalTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test ObjectExternalTest.ObjectFlags_ConsecutiveBits
 * @brief Verifies object Flags Consecutive Bits.
 *
 * @details
 * Exercises the ObjectExternalTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test ObjectExternalTest.ObjectFlags_Unique
 * @brief Verifies object Flags Unique.
 *
 * @details
 * Exercises the ObjectExternalTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test ObjectExternalTest.ObjectFlags_Lifecycle
 * @brief Verifies object Flags Lifecycle.
 *
 * @details
 * Exercises the ObjectExternalTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test ObjectExternalTest.ObjectFlags_Multiplayer
 * @brief Verifies object Flags Multiplayer.
 *
 * @details
 * Exercises the ObjectExternalTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test ObjectExternalTest.ObjectFlags_Rendering
 * @brief Verifies object Flags Rendering.
 *
 * @details
 * Exercises the ObjectExternalTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
