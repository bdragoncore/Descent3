/**
 * @file math_generators.cpp
 * @brief D3 Coverage Tests - Test Data Generators.
 *
 * @details
 * Provides deterministic random data generation for coverage tests.
 * Uses seeded RNG for reproducibility.
 *
 * This harness validates the behavior of `Descent3/math_generators.cpp`. It compiles the real
 * implementation (or a minimal replica when isolation is required) against
 * stubbed engine subsystems and checks the observable contract documented
 * in the source headers and in-game behavior.
 *
 * @par Source
 * `Descent3/math_generators.cpp`
 * @par Harness
 * `math_generators.cpp`
 * @par Framework
 ...
 * @see Descent3/math_generators.cpp
 */
