/**
 * @file pcx_loader_tests.cpp
 * @brief Unit tests for Descent3/pcx_loader.cpp.
 *
 * @details
 * Covers the public contract of `Descent3/pcx_loader.cpp` — construction, state transitions, error handling and edge cases exercised through the GoogleTest harness.
 *
 * This harness validates the behavior of `Descent3/pcx_loader.cpp`. It compiles the real
 * implementation (or a minimal replica when isolation is required) against
 * stubbed engine subsystems and checks the observable contract documented
 * in the source headers and in-game behavior.
 *
 * @par Source
 * `Descent3/pcx_loader.cpp`
 * @par Harness
 * `pcx_loader_tests.cpp`
 * @par Framework
...
/**
 * @brief GTest fixture for PCXLoaderTest.
 * @details
...
/**
 * @test PCXLoaderTest.LoadPCX8BitFromMemory
 * @brief Verifies load PCX8Bit From Memory.
 *
 * @details
 * Exercises the PCXLoaderTest code path and asserts observable
...
/**
 * @test PCXLoaderTest.LoadPCX24BitFromMemory
 * @brief Verifies load PCX24Bit From Memory.
 *
 * @details
 * Exercises the PCXLoaderTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test PCXLoaderTest.LoadPCXInvalidFile
 * @brief Verifies load PCXInvalid File.
 *
 * @details
 * Exercises the PCXLoaderTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test PCXLoaderTest.LoadPCXNonPCXFile
 * @brief Verifies load PCXNon PCXFile.
 *
 * @details
 * Exercises the PCXLoaderTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test PCXLoaderTest.LoadPCXEmptyFile
 * @brief Verifies load PCXEmpty File.
 *
 * @details
 * Exercises the PCXLoaderTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test PCXLoaderTest.LoadPCXFileNotFound
 * @brief Verifies load PCXFile Not Found.
 *
 * @details
 * Exercises the PCXLoaderTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test PCXLoaderTest.LoadMultiplePCX
 * @brief Verifies load Multiple PCX.
 *
 * @details
 * Exercises the PCXLoaderTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test PCXLoaderTest.PCXDirectAllocFile
 * @brief Verifies pCXDirect Alloc File.
 *
 * @details
 * Exercises the PCXLoaderTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test PCXLoaderTest.PCXSmallSize
 * @brief Verifies pCXSmall Size.
 *
 * @details
 * Exercises the PCXLoaderTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test PCXLoaderTest.PCXLargeSize
 * @brief Verifies pCXLarge Size.
 *
 * @details
 * Exercises the PCXLoaderTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test PCXLoaderTest.PCXRectangular
 * @brief Verifies pCXRectangular.
 *
 * @details
 * Exercises the PCXLoaderTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
