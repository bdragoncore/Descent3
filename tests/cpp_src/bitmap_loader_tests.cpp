/**
 * @file bitmap_loader_tests.cpp
 * @brief Unit tests for Descent3/bitmap_loader.cpp.
 *
 * @details
 * Covers the public contract of `Descent3/bitmap_loader.cpp` — construction, state transitions, error handling and edge cases exercised through the GoogleTest harness.
 *
 * This harness validates the behavior of `Descent3/bitmap_loader.cpp`. It compiles the real
 * implementation (or a minimal replica when isolation is required) against
 * stubbed engine subsystems and checks the observable contract documented
 * in the source headers and in-game behavior.
 *
 * @par Source
 * `Descent3/bitmap_loader.cpp`
 * @par Harness
 * `bitmap_loader_tests.cpp`
 * @par Framework
 ...
 * @see Descent3/bitmap_loader.cpp
 */
...
/**
 * @brief GTest fixture for BitmapLoaderTest.
 * @details
...
/**
 * @test BitmapLoaderTest.BitmapHandleValidRange
 * @brief Verifies bitmap Handle Valid Range.
 *
 * @details
...
/**
 * @test BitmapLoaderTest.BitmapDataAccess
 * @brief Verifies bitmap Data Access.
 *
 * @details
 * Exercises the BitmapLoaderTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test BitmapLoaderTest.BitmapRowsizeCalculation
 * @brief Verifies bitmap Rowsize Calculation.
 *
 * @details
 * Exercises the BitmapLoaderTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test BitmapLoaderTest.MultipleBitmapAllocation
 * @brief Verifies multiple Bitmap Allocation.
 *
 * @details
 * Exercises the BitmapLoaderTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test BitmapLoaderTest.FreeInvalidHandle
 * @brief Verifies free Invalid Handle.
 *
 * @details
 * Exercises the BitmapLoaderTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test BitmapLoaderTest.FreeAlreadyFreed
 * @brief Verifies free Already Freed.
 *
 * @details
 * Exercises the BitmapLoaderTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test BitmapLoaderTest.SquareBitmap
 * @brief Verifies square Bitmap.
 *
 * @details
 * Exercises the BitmapLoaderTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test BitmapLoaderTest.RectangularBitmap
 * @brief Verifies rectangular Bitmap.
 *
 * @details
 * Exercises the BitmapLoaderTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test BitmapLoaderTest.DefaultMipLevelCount
 * @brief Verifies default Mip Level Count.
 *
 * @details
 * Exercises the BitmapLoaderTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test BitmapLoaderTest.MippedFlag
...
/**
 * @test BitmapLoaderTest.DefaultFormat
 * @brief Verifies default Format.
 *
 * @details
 * Exercises the BitmapLoaderTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test BitmapLoaderTest.BPPValue
 * @brief Verifies bPPValue.
 *
 * @details
 * Exercises the BitmapLoaderTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test BitmapLoaderTest.PixelReadWrite
 * @brief Verifies pixel Read Write.
 *
 * @details
 * Exercises the BitmapLoaderTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test BitmapLoaderTest.PixelTransparency
 * @brief Verifies pixel Transparency.
 *
 * @details
 * Exercises the BitmapLoaderTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test BitmapLoaderTest.MinimumSize
 * @brief Verifies minimum Size.
 *
 * @details
 * Exercises the BitmapLoaderTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test BitmapLoaderTest.LargeBitmap
...
/**
 * @test BitmapLoaderTest.UsedFlagAfterFree
 * @brief Verifies used Flag After Free.
 *
 * @details
 * Exercises the BitmapLoaderTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test BitmapLoaderTest.FindBitmapNameNotFound
...
/**
 * @test BitmapLoaderTest.LoadTGAFromMemory
 * @brief Verifies load TGAFrom Memory.
 *
 * @details
 * Exercises the BitmapLoaderTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test BitmapLoaderTest.LoadTGAFromMemoryNonMipped
 * @brief Verifies load TGAFrom Memory Non Mipped.
 *
 * @details
 * Exercises the BitmapLoaderTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test BitmapLoaderTest.LoadTGAFromMemoryMipped
 * @brief Verifies load TGAFrom Memory Mipped.
 *
 * @details
 * Exercises the BitmapLoaderTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test BitmapLoaderTest.LoadTGAInvalidFile
 * @brief Verifies load TGAInvalid File.
 *
 * @details
 * Exercises the BitmapLoaderTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test BitmapLoaderTest.LoadOGFFromMemory
 * @brief Verifies load OGFFrom Memory.
 *
 * @details
 * Exercises the BitmapLoaderTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test BitmapLoaderTest.LoadTGAFileNotFound
 * @brief Verifies load TGAFile Not Found.
 *
 * @details
 * Exercises the BitmapLoaderTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test BitmapLoaderTest.LoadMultipleTGA
 * @brief Verifies load Multiple TGA.
 *
 * @details
 * Exercises the BitmapLoaderTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
