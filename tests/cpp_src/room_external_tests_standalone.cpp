/**
 * @file room_external_tests_standalone.cpp
 * @brief D3 Coverage Tests - Descent3/room_external module (Standalone).
 *
 * @details
 * Tests for room, face, and portal constants and flags.
 * These define the world geometry structure.
 *
 * This harness validates the behavior of `Descent3/room_external_tests_standalone.cpp`. It compiles the real
 * implementation (or a minimal replica when isolation is required) against
 * stubbed engine subsystems and checks the observable contract documented
 * in the source headers and in-game behavior.
 *
 * @par Source
 * `Descent3/room_external_tests_standalone.cpp`
 * @par Harness
 * `room_external_tests_standalone.cpp`
 * @par Framework
 ...
 * @see Descent3/room_external_tests_standalone.cpp
 */
...
/**
 * @brief GTest fixture for RoomExternalTest.
 * @details
...
/**
 * @test RoomExternalTest.MaxFacesPerRoom_Positive
 * @brief Verifies max Faces Per Room Positive.
 *
 * @details
 * Exercises the RoomExternalTest code path and asserts observable
...
/**
 * @test RoomExternalTest.MaxVertsPerRoom_Positive
 * @brief Verifies max Verts Per Room Positive.
 *
 * @details
 * Exercises the RoomExternalTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test RoomExternalTest.MaxVertsPerFace_Positive
 * @brief Verifies max Verts Per Face Positive.
 *
 * @details
 * Exercises the RoomExternalTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test RoomExternalTest.MaxValues_ReasonableRange
...
/**
 * @test RoomExternalTest.MaxVertsPerFace_PowerOfTwo
 * @brief Verifies max Verts Per Face Power Of Two.
 *
 * @details
 * Exercises the RoomExternalTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test RoomExternalTest.FaceFlags_Defined
 * @brief Verifies face Flags Defined.
 *
 * @details
 * Exercises the RoomExternalTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test RoomExternalTest.FaceFlags_PowersOfTwo
 * @brief Verifies face Flags Powers Of Two.
 *
 * @details
 * Exercises the RoomExternalTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test RoomExternalTest.FaceFlags_ConsecutiveBits
 * @brief Verifies face Flags Consecutive Bits.
 *
 * @details
 * Exercises the RoomExternalTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test RoomExternalTest.FaceFlags_Unique
 * @brief Verifies face Flags Unique.
 *
 * @details
 * Exercises the RoomExternalTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test RoomExternalTest.PortalFlags_Defined
 * @brief Verifies portal Flags Defined.
 *
 * @details
 * Exercises the RoomExternalTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test RoomExternalTest.PortalFlags_PowersOfTwo
 * @brief Verifies portal Flags Powers Of Two.
 *
 * @details
 * Exercises the RoomExternalTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test RoomExternalTest.PortalFlags_ConsecutiveBits
 * @brief Verifies portal Flags Consecutive Bits.
 *
 * @details
 * Exercises the RoomExternalTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test RoomExternalTest.RoomFlags_Basic_Defined
 * @brief Verifies room Flags Basic Defined.
 *
 * @details
 * Exercises the RoomExternalTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test RoomExternalTest.RoomFlags_Special_Defined
 * @brief Verifies room Flags Special Defined.
 *
 * @details
 * Exercises the RoomExternalTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test RoomExternalTest.RoomFlags_Advanced_Defined
 * @brief Verifies room Flags Advanced Defined.
 *
 * @details
 * Exercises the RoomExternalTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test RoomExternalTest.RoomFlags_PowersOfTwo
 * @brief Verifies room Flags Powers Of Two.
 *
 * @details
 * Exercises the RoomExternalTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test RoomExternalTest.RoomFlags_Unique
 * @brief Verifies room Flags Unique.
 *
 * @details
 * Exercises the RoomExternalTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test RoomExternalTest.MineMask_Value
 * @brief Verifies mine Mask Value.
 *
 * @details
 * Exercises the RoomExternalTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test RoomExternalTest.MineMask_Bits
 * @brief Verifies mine Mask Bits.
 *
 * @details
 * Exercises the RoomExternalTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test RoomExternalTest.MineMask_Capacity
 * @brief Verifies mine Mask Capacity.
 *
 * @details
 * Exercises the RoomExternalTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test RoomExternalTest.GoalRoomMask_Value
 * @brief Verifies goal Room Mask Value.
 *
 * @details
 * Exercises the RoomExternalTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test RoomExternalTest.GoalRoomMask_IncludesAllGoals
 * @brief Verifies goal Room Mask Includes All Goals.
 *
 * @details
 * Exercises the RoomExternalTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test RoomExternalTest.GoalRoomMask_NoOtherFlags
 * @brief Verifies goal Room Mask No Other Flags.
 *
 * @details
 * Exercises the RoomExternalTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test RoomExternalTest.RoomNameLen_Positive
 * @brief Verifies room Name Len Positive.
 *
 * @details
 * Exercises the RoomExternalTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test RoomExternalTest.RoomNameLen_Reasonable
 * @brief Verifies room Name Len Reasonable.
 *
 * @details
 * Exercises the RoomExternalTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test RoomExternalTest.RoomFlag_FuelAndDoor
 * @brief Verifies room Flag Fuel And Door.
 *
 * @details
 * Exercises the RoomExternalTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test RoomExternalTest.RoomFlag_ExternalAndTerrain
 * @brief Verifies room Flag External And Terrain.
 *
 * @details
 * Exercises the RoomExternalTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test RoomExternalTest.RoomFlag_LightingEffects
 * @brief Verifies room Flag Lighting Effects.
 *
 * @details
 * Exercises the RoomExternalTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test RoomExternalTest.RoomFlag_NoLight_Incompatible
 * @brief Verifies room Flag No Light Incompatible.
 *
 * @details
 * Exercises the RoomExternalTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test RoomExternalTest.FaceFlags_Rendering
 * @brief Verifies face Flags Rendering.
 *
 * @details
 * Exercises the RoomExternalTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test RoomExternalTest.FaceFlags_Damage
 * @brief Verifies face Flags Damage.
 *
 * @details
 * Exercises the RoomExternalTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test RoomExternalTest.FaceFlags_Trigger
 * @brief Verifies face Flags Trigger.
 *
 * @details
 * Exercises the RoomExternalTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
