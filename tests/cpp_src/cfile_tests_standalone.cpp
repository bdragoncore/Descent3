/**
 * @file cfile_tests_standalone.cpp
 * @brief D3 Coverage Tests - cfile module (Standalone).
 *
 * @details
 * Tests for cfile functions using the mock infrastructure.
 * Uses seeded RNG for reproducible test data.
 *
 * This harness validates the behavior of `Descent3/cfile_tests_standalone.cpp`. It compiles the real
 * implementation (or a minimal replica when isolation is required) against
 * stubbed engine subsystems and checks the observable contract documented
 * in the source headers and in-game behavior.
 *
 * @par Source
 * `Descent3/cfile_tests_standalone.cpp`
 * @par Harness
 * `cfile_tests_standalone.cpp`
 * @par Framework
 ...
 * @see Descent3/cfile_tests_standalone.cpp
 */
...
/**
 * @brief GTest fixture for CFileTest.
 * @details
...
/**
 * @test CFileTest.OpenExistingFile
 * @brief Verifies open Existing File.
 *
 * @details
 * Exercises the CFileTest code path and asserts observable
...
/**
 * @test CFileTest.OpenNonExistentFile
...
/**
 * @test CFileTest.ReadMultipleInts
...
/**
 * @test CFileTest.ReadDouble
 * @brief Verifies read Double.
 *
 * @details
 * Exercises the CFileTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test CFileTest.WriteAndReadInt
 * @brief Verifies write And Read Int.
 *
 * @details
 * Exercises the CFileTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test CFileTest.WriteAndReadShort
 * @brief Verifies write And Read Short.
 *
 * @details
 * Exercises the CFileTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test CFileTest.WriteAndReadByte
 * @brief Verifies write And Read Byte.
 *
 * @details
 * Exercises the CFileTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test CFileTest.WriteAndReadFloat
 * @brief Verifies write And Read Float.
 *
 * @details
 * Exercises the CFileTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test CFileTest.WriteAndReadDouble
 * @brief Verifies write And Read Double.
 *
 * @details
 * Exercises the CFileTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test CFileTest.WriteAndReadBytes
 * @brief Verifies write And Read Bytes.
 *
 * @details
 * Exercises the CFileTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test CFileTest.WriteAndReadString
 * @brief Verifies write And Read String.
 *
 * @details
 * Exercises the CFileTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test CFileTest.ZeroValue
 * @brief Verifies zero Value.
 *
 * @details
 * Exercises the CFileTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test CFileTest.MaxValues
 * @brief Verifies max Values.
 *
 * @details
 * Exercises the CFileTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
...
/**
 * @test CFileTest.NegativeValues
 * @brief Verifies negative Values.
 *
 * @details
 * Exercises the CFileTest code path and asserts observable
 * post-conditions. Stubbed subsystems provide deterministic
